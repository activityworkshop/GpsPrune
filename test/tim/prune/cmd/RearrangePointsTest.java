...
class RearrangePointsTest
{
	...
	public void testMoveTwo()
	{
		...
		List<Integer> desiredOrder = ListUtils.makeList(0, 3, 4, 1, 2, 5);
	...
	public void testRearrangeWithDuplicateIndexesFails()
	{
		...
		testExpectedFail(ListUtils.makeList(0, 3, 4, 1, 3, 5));
	}
	...
	public void testRearrangeWithSmallerSizeFails()
	{
		...
		testExpectedFail(ListUtils.makeList(0, 3, 4, 1, 2));
	}

	@Test
	public void testRearrangeWithNegativeIndexFails() {
		testExpectedFail(ListUtils.makeList(0, 3, 4, 1, -2, 5));
	}

	@Test
	public void testRearrangeWithTooLargeIndexFails() {
		testExpectedFail(ListUtils.makeList(0, 3, 4, 1, 12, 5));
	}
